...
# 1. 配置
# =========================
train_csv = "autodl-tmp/data_files/input_dataset/okvqa_answer_generate_train.csv"
val_csv   = "autodl-tmp/data_files/input_dataset/okvqa_answer_generate_val.csv"
