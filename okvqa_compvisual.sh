...
FILE_PATH="autodl-tmp/output_files/okvqa_${large_model_name}_${small_model_name}_compvisual_${split}/"
VAL_DATASET="autodl-tmp/data_files/input_dataset/okvqa_${large_model_name}_${small_model_name}_compvisual_${split}.csv"
