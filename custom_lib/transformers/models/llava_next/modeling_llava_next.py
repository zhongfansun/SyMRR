        ...
        if inputs_embeds is None:
            ...
            if pixel_values is not None and input_ids.shape[1] != 1 and pixel_values.size(0) > 0:
                ...
                image_num_patches_first = [
                    image_num_patches_all[i] for i in first_image_indices
                ]

                image_sizes_first = [
                    image_sizes[i] for i in first_image_indices
                ]
                ...
                if pixel_values.dim() == 5:
                    ...
                    first_pixel_values_list = [
                        pixel_values_split[i]
                        for i in first_image_indices
                    ]

                    second_global_pixel_values_list = [
                        pixel_values_split[i][:1]
                        for i in second_image_indices
                    ]
                ...
                selected_image_feature_first = image_features_first.hidden_states[vision_feature_layer]

                if vision_feature_select_strategy == "default":
                    selected_image_feature_first = selected_image_feature_first[:, 1:]
                elif vision_feature_select_strategy == "full":
                    selected_image_feature_first = selected_image_feature_first
                ...
                for i, cur_image_feature in enumerate(image_features_split):
                    ...
                    if cur_mapping_text.dim() == 1:
                        cur_mapping_text = cur_mapping_text.unsqueeze(0)

                    cur_mapping_vision = cur_mapping_vision.to(
                        device=cur_image_feature.device,
                        dtype=cur_image_feature.dtype,
                    )
                    cur_mapping_text = cur_mapping_text.to(
                        device=cur_image_feature.device,
                        dtype=cur_image_feature.dtype,
                    )
